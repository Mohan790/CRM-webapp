    ...
    if ($d) {
        ...
        if (Password::_verify($password, $d_pass) == true) {
            ...
            if ($d['otp'] == 'Yes') {
                ...
                Installation Successful! Please Set your Full Name, Username, Password. The Default Username is - admin@admin.com And Password: 123456 Please change it From This Page.
                '
                );
